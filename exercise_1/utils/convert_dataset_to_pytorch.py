...
def convert_dataset_to_pytorch(dataset_train, labels_train, dataset_val, labels_val, batch_size):
    dataset_pytorch_train = CircleSquareDataset(dataset_train, labels_train)
    dataset_pytorch_val = CircleSquareDataset(dataset_val, labels_val)
